...
def button():
	...
	BUTTON+=[[InlineKeyboardButton(text="🌱 BİR ANKARA 🌱",url="https://t.me/kizilsancak06")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben Kaybedenler Eğlence Botuyum:) \nMusic Botumuzu Denediniz Mi @kaybedenlermusicbot Oyun Komutu => /sor".format(
